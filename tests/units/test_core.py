...
class TestCore(TestCoreBase):
    SUPPORTED_PRODUCT_TYPES = {
        ...
        "CLMS_CORINE": ["dedl", "wekeo_sentinel"],
        "CLMS_GLO_DMP_333M": ["dedl", "wekeo_sentinel"],
        "CLMS_GLO_FAPAR_333M": ["dedl", "wekeo_sentinel"],
        "CLMS_GLO_FCOVER_333M": ["dedl", "wekeo_sentinel"],
        "CLMS_GLO_GDMP_333M": ["dedl", "wekeo_sentinel"],
        "CLMS_GLO_LAI_333M": ["dedl", "wekeo_sentinel"],
        "CLMS_GLO_NDVI_1KM_LTS": ["dedl", "wekeo_sentinel"],
        "CLMS_GLO_NDVI_333M": ["dedl", "wekeo_sentinel"],
        "COP_DEM_GLO30_DGED": [
            "creodias",
            "creodias_s3",
            "dedl",
        ...
        "COP_DEM_GLO30_DTED": ["creodias", "creodias_s3", "dedl", "wekeo_sentinel"],
        "COP_DEM_GLO90_DGED": [
            "creodias",
            "creodias_s3",
            "dedl",
        ...
        "COP_DEM_GLO90_DTED": ["creodias", "creodias_s3", "dedl", "wekeo_sentinel"],
        "DT_EXTREMES": ["dedl", "dedt_lumi"],
        "DT_CLIMATE_ADAPTATION": ["dedl", "dedt_lumi"],
        "EEA_DAILY_VI": ["dedl", "wekeo_sentinel"],
        ...
        "GRIDDED_GLACIERS_MASS_CHANGE": ["dedl", "wekeo_ecmwf"],
        ...
        "S3_LAN_HY": ["wekeo_sentinel"],
        "S3_LAN_SI": ["wekeo_sentinel"],
        "S3_LAN_LI": ["wekeo_sentinel"],
        "S5P_L1B_IR_ALL": ["dedl", "wekeo_sentinel"],
        "S5P_L2_IR_ALL": ["dedl", "wekeo_sentinel"],
